...
<div class="form-container">
	<form class="forms" action="regWork.jsp" method="post">
		<fieldset>
			<ol>
				<li class="form-row text-input-row"><label>First Name</label><input type="text" name="fname" value="" class="text-input required" title="" /></li>
				<li class="form-row text-input-row"><label>Last Name</label><input type="text" name="lname" value="" class="text-input required email" title="" /></li> 				
				...
				<li class="form-row text-input-row"><label>Country</label>
				<div id="registration-form" class="registration-form">
				<p class="registration-name">
			...
			<li class="form-row text-input-row"><label>Email</label><input type="text" name="email" class="text-input required email" title="" /></li> 
			<li class="form-row text-input-row"><label>Create a password</label><input type="password" name="pass2" value="" class="text-input required email" title="" /></li> 
			<li class="form-row text-input-row"><label>Confirm Password</label><input type="password" name="passw" value="" class="text-input required email" title="" /></li>
		<br>
		<br> 
