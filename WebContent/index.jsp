	...
	<div class="header">
		...
		<div id="menu-wrapper">
			<div id="menu" class="menu">
				<ul id="tiny">
					<li class="active"><a href="index.jsp">Blog</a>
						<ul>
							<li><a href="post1.jsp">Blog Post</a></li>
						</ul>
					</li>
					<li><a href="page-with-sidebar.jsp">Pages</a>
						<ul>
							<li><a href="page-with-sidebar.jsp">Page With Sidebar</a></li>
							<li><a href="full-width.jsp">Full Width</a></li>
						</ul>
					</li>
					<li><a href="typography.jsp">Styles</a>
						<ul>
...
<div class="transbox1">
<h4>Best of Show: Evolve</h4><img class="thumbnail" src="style/images/art/c1.jpg" width="500" height="550">
...
<!-- Begin Page-navi -->
     ...
     <div class="transbox2">
				<ul>
					<h4><a href="index.html">1 </a>|
						
					
					<a href="page-with-sidebar.html">2 </a>|
						
					
					<a href="typography.html">3 </a>|
						
					
					
					<a href="contact.html">4</a></h4>
				</ul>
			</div>
      <!-- 
